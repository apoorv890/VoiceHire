...
import { Lock, Mail, User, ArrowRight, Briefcase, UserCircle } from 'lucide-react';
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          >
                            ...
                            <span className="text-xs text-gray-500 mt-1">Post jobs & hire</span>
                          </button>
                          <button
                            type="button"
                          ...
                          >
                            ...
                            <span className="text-xs text-gray-500 mt-1">Find & apply</span>
                          </button>
                        </div>
                      </div>
                    </>
